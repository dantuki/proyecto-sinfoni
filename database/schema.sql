...
-- 2. TABLA: USUARIOS (Incorpora campos educativos y de nacimiento)
...
-- 3. TABLA: CONVOCATORIAS (Estructura definitiva)
...
-- 4. TABLA: SOLICITUDES (Estructura definitiva con título de propuesta y motivo)
...
estado ENUM('Borrador', 'Enviada', 'En Revision', 'Aceptada', 'Rechazada') DEFAULT 'Borrador',
...
-- 9. TABLA: DOCUMENTOS_SOLICITUD (Múltiples archivos por postulación)
